...
WebUI.setText(findTestObject('Customer/SignUpPage_Reach_Customer/input_Email_email'), GlobalVariable.username9)

WebUI.click(findTestObject('Customer/SignUpPage_Reach_Customer/button_Create Account'))

WebUI.setText(findTestObject('Customer/SignUpPage_Reach_Customer/input_Company Name_name'), 'Sinarmas')
...
WebUI.setText(findTestObject('Agent/Sign Up Page Reach Agent/input2'), '7')

WebUI.click(findTestObject('Agent/Sign Up Page Reach Agent/input3'))

WebUI.setText(findTestObject('Agent/Sign Up Page Reach Agent/input3'), '4')
...
WebUI.verifyElementVisible(findTestObject('Customer/SignUpPage_Reach_Customer/div_OTP Wrong'))
