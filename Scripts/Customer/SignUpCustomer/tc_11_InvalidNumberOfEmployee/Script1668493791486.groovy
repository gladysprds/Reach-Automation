...
WebUI.setText(findTestObject('Customer/SignUpPage_Reach_Customer/input_Number Of Employees_headcount'), 'twelve')
...
WebUI.verifyElementVisible(findTestObject('Customer/SignUpPage_Reach_Customer/div_Please input number of employee'))
