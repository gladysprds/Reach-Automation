...
WebUI.setText(findTestObject('Customer/SignUpPage_Reach_Customer/input_Email_email'), GlobalVariable.username8)
...
WebUI.click(findTestObject('Customer/SignUpPage_Reach_Customer/input_promotion_email'))
...
WebUI.click(findTestObject('Customer/SignUpPage_Reach_Customer/span_Dashboard'))
