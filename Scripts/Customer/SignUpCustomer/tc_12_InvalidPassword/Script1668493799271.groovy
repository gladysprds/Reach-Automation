...
WebUI.setEncryptedText(findTestObject('Customer/SignUpPage_Reach_Customer/input_Create New Password_password'), 'UIpTJbWz5b2dzpd1CNfJTw==')

WebUI.click(findTestObject('Customer/SignUpPage_Reach_Customer/input_agree_checkbox'))

WebUI.click(findTestObject('Customer/SignUpPage_Reach_Customer/button_Create Account'))

WebUI.verifyElementVisible(findTestObject('Customer/SignUpPage_Reach_Customer/div_Please input your Password'))
