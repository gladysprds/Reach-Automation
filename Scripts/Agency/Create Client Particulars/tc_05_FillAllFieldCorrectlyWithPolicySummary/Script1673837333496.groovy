...
WebUI.uploadFile(findTestObject('Agent/Create Client Particular/Page_Reach/button_upload policy summary'), file)
...
WebUI.setText(findTestObject('Agent/Create Client Particular/Page_Reach/Field_Email'), GlobalVariable.EmailClient)

WebUI.setText(findTestObject('Agent/Create Client Particular/Page_Reach/Field_Email'), RandomStringUtils.randomNumeric(3) + 
    '@example.com')
...
WebUI.verifyElementText(findTestObject('Agent/Create Client Particular/Page_Reach/Unique_verify_Client Particular'), 'ClientParticular1')

WebUI.verifyElementText(findTestObject('Agent/Create Client Particular/Page_Reach/Unique_verify_client_address'), 'Saint Vincent Downway #112')

WebUI.verifyElementText(findTestObject('Agent/Create Client Particular/Page_Reach/Unique_verify_NRIC'), '****1131')

WebUI.verifyElementText(findTestObject('Agent/Create Client Particular/Page_Reach/Unique_Verify_Nationality'), 'Singaporean')

WebUI.verifyElementText(findTestObject('Agent/Create Client Particular/Page_Reach/Unique_Verify Date Of Birthday'), '01 January 2023')

WebUI.verifyElementText(findTestObject('Agent/Create Client Particular/Page_Reach/Unique_Verify_Smoker status'), 'Non Smoker')

WebUI.verifyElementText(findTestObject('Agent/Create Client Particular/Page_Reach/Unique_verify_Gender'), 'Male')

WebUI.verifyElementText(findTestObject('Agent/Create Client Particular/Page_Reach/Unique_verify_marital status'), 'Single')

WebUI.verifyElementText(findTestObject('Agent/Create Client Particular/Page_Reach/Unique_verify_contact number'), '+65123456789')
