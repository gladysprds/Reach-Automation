...
WebUI.setText(findTestObject('Agency/Create Client Particular/Page_Reach/Field_Email'), 'client@')
...
WebUI.verifyElementText(findTestObject('Agency/Create Client Particular/Page_Reach/Unique_Verify Error'), 'Mandatory field is required to be filled before creating Client Particular.')
