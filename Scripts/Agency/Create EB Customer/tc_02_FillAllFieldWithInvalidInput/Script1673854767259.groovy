...
WebUI.setText(findTestObject('Agency/Create EB Customer/Page_Reach/Field_Email_Login'), 'agentlife@example.com')
...
WebUI.verifyElementText(findTestObject('Agency/Create EB Customer/Page_Reach/span_Dashboard'), 'Dashboard')
...
WebUI.setText(findTestObject('Agency/Create EB Customer/Page_Reach/Field_Headcounts'), GlobalVariable.invalidHeadCount)
...
WebUI.setText(findTestObject('Agency/Create EB Customer/Page_Reach/Field_Expected Annual'), GlobalVariable.InvalidEstimateAnnualRevenue)

WebUI.setText(findTestObject('Agency/Create EB Customer/Page_Reach/Field_Contact Name'), GlobalVariable.ContactName)

WebUI.setText(findTestObject('Agency/Create EB Customer/Page_Reach/Field_Email'), GlobalVariable.invalidEmailCustomer)
