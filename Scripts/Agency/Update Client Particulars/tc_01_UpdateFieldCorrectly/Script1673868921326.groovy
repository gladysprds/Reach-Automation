...
WebUI.callTestCase(findTestCase('Agency/Create Client Particulars/tc_01_FilledAllFieldCorrectly'), [:], FailureHandling.STOP_ON_FAILURE)

WebUI.click(findTestObject('Agency/Create Client Particular/Page_Reach/button_Edit'))

WebUI.setText(findTestObject('Agency/Create Client Particular/Page_Reach/Field_Client Name'), 'update')

WebUI.setText(findTestObject('Agency/Create Client Particular/Page_Reach/Field_Address'), 'update')

WebUI.setText(findTestObject('Agency/Create Client Particular/Page_Reach/Field_NRIC Number'), '0')
