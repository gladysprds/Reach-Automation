...
WebUI.setText(findTestObject('Agency/SignUpPage_Reach_Agency/input_Mus Number_musNumber'), '12345678910112')
...
WebUI.verifyElementText(findTestObject('Agency/SignUpPage_Reach_Agency/div_Please_Input_Your_MussNumberMoreLess'), 'Mas number must be maximum 9 characters.')
