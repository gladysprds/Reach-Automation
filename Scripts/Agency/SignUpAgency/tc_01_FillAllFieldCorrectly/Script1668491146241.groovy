...
WebUI.setText(findTestObject('Agency/SignUpPage_Reach_Agency/input_Email_email'), GlobalVariable.username)
...
WebUI.setText(findTestObject('Agency/SignUpPage_Reach_Agency/input_Contact Name_contactName'), 'agencyqa')
...
WebUI.click(findTestObject('Agency/SignUpPage_Reach_Agency/input'))

WebUI.setText(findTestObject('Agency/SignUpPage_Reach_Agency/input'), '5')

WebUI.click(findTestObject('Agency/SignUpPage_Reach_Agency/input2'))

WebUI.setText(findTestObject('Agency/SignUpPage_Reach_Agency/input2'), '5')

WebUI.click(findTestObject('Agency/SignUpPage_Reach_Agency/input3'))

WebUI.setText(findTestObject('Agency/SignUpPage_Reach_Agency/input3'), '5')

WebUI.click(findTestObject('Agency/SignUpPage_Reach_Agency/input4'))

WebUI.setText(findTestObject('Agency/SignUpPage_Reach_Agency/input4'), '5')

WebUI.click(findTestObject('Agency/SignUpPage_Reach_Agency/button_Ok, Select Insurer'))

WebUI.click(findTestObject('Agency/SignUpPage_Reach_Agency/input_Maynard and Nunez Associates_42'))

WebUI.click(findTestObject('Agency/SignUpPage_Reach_Agency/button_finish'))

WebUI.verifyElementVisible(findTestObject('Agency/SignUpPage_Reach_Agency/span_Dashboard'))
