...
WebUI.setText(findTestObject('Agency/SignUpPage_Reach_Agency/input_Email_email'), GlobalVariable.username3)
...
WebUI.setText(findTestObject('Agency/SignUpPage_Reach_Agency/input'), '9')
...
WebUI.setText(findTestObject('Agency/SignUpPage_Reach_Agency/input3'), '9')
...
WebUI.verifyElementText(findTestObject('Agency/SignUpPage_Reach_Agency/div_OTP Wrong'), 'OTP’s code wrong')
