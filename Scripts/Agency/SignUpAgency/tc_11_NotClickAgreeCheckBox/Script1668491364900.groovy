...
WebUI.setText(findTestObject('Agency/SignUpPage_Reach_Agency/input_Phone Number_contactNumber'), '1234 567 8')
...
WebUI.verifyElementNotClickable(findTestObject('Agency/SignUpPage_Reach_Agency/button_Create Account'))
