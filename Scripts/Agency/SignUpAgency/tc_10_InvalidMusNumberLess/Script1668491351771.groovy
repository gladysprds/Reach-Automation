...
WebUI.setText(findTestObject('Agency/SignUpPage_Reach_Agency/input_Mus Number_musNumber'), '1234')
...
WebUI.verifyElementText(findTestObject('Agency/SignUpPage_Reach_Agency/div_Please_Input_Your_MussNumberMoreLess'), 'Mas number must be minimum 8 characters.')
