...
WebUI.verifyElementVisible(findTestObject('Admin/Create Customer/Unique_Error_MandatoryField2'), FailureHandling.STOP_ON_FAILURE)

WebUI.getText(findTestObject('Admin/Create Customer/Unique_Error_MandatoryField2'))
