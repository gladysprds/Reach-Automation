...
WebUI.setText(findTestObject('Admin/Create Customer/Field_Estimated Annual Revenue'), GlobalVariable.InvalidEstimateAnnualRevenue)
...
WebUI.setText(findTestObject('Admin/Create Customer/Field_Phone_Number'), GlobalVariable.AgencyContactNumber)
...
WebUI.verifyElementVisible(findTestObject('Admin/Create Customer/unique_EstimateHeadCount'), FailureHandling.STOP_ON_FAILURE)

WebUI.verifyTextPresent('Please enter commission Amount', true)
