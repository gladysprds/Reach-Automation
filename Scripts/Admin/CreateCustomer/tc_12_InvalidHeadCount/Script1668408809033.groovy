...
WebUI.setText(findTestObject('Admin/Create Customer/Field_Headcount'), GlobalVariable.invalidHeadCount)
...
WebUI.verifyElementVisible(findTestObject('Admin/Create Customer/Unique_errorHeadCount'), FailureHandling.STOP_ON_FAILURE)

WebUI.verifyTextPresent('Please enter valid headcount', true)
