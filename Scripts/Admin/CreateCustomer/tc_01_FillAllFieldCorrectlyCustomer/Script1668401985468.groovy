...
WebUI.navigateToUrl('https://reach-dev.embreo.global')
...
WebUI.setText(findTestObject('Admin/Create Customer/Field_ContactName'), GlobalVariable.CompanyContactName)

WebUI.setText(findTestObject('Admin/Create Customer/Field_Email'), GlobalVariable.EmailClientCustomer)

WebUI.setText(findTestObject('Admin/Create Customer/Field_Email'), RandomStringUtils.randomNumeric(2) + '.com')

WebUI.setText(findTestObject('Admin/Create Customer/Field_Phone_Number'), GlobalVariable.ContactNumber)

WebUI.setText(findTestObject('Admin/Create Customer/Field_Jobs'), GlobalVariable.Jobs)

WebUI.waitForElementClickable(findTestObject('Admin/Create Customer/Button_Create'), 10)

WebUI.click(findTestObject('Admin/Create Customer/Button_Create'))

WebUI.verifyElementText(findTestObject('Admin/Create Customer/Unique_newcustomer'), 'Excalibur101')
