...
WebUI.setText(findTestObject('Admin/Create Customer/Field_Email'), GlobalVariable.invalidEmailCustomer)
...
WebUI.verifyElementVisible(findTestObject('Admin/Create Customer/Unique_invalidemail'), FailureHandling.STOP_ON_FAILURE)

WebUI.verifyTextPresent('The input is not valid E-mail!', true)
