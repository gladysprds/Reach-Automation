...
WebUI.setText(findTestObject('Admin/Create Insurer/Field_Email'), RandomStringUtils.randomNumeric(2) + '.com')
...
WebUI.verifyElementText(findTestObject('Admin/Create Insurer/Unique_New Insurer'), 'Seainsure3')
