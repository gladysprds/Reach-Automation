...
WebUI.setText(findTestObject('Admin/Create Agency/Field_Agency Name'), GlobalVariable.AgencyName2)
...
WebUI.click(findTestObject('Admin/Create Agency/Unique_General and Life License'))
...
WebUI.setText(findTestObject('Admin/Create Agency/Field_Email Agency'), GlobalVariable.AgencyEmail5)

WebUI.setText(findTestObject('Admin/Create Agency/Field_Contact Number'), GlobalVariable.AgencyContactNumber)

WebUI.click(findTestObject('Admin/Create Agency/Unique_Representing Insurer Bar2'))
...
WebUI.verifyElementText(findTestObject('Admin/Create Agency/Unique_agency name'), 'reachwebtest2')
