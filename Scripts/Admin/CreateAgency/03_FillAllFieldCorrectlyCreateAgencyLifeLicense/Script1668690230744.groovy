...
WebUI.setText(findTestObject('Admin/Create Agency/Field_Agency Name'), GlobalVariable.AgencyName3)

WebUI.setText(findTestObject('Admin/Create Agency/Field_Head Name Agency'), GlobalVariable.PolicyName3)
...
WebUI.click(findTestObject('Admin/Create Agency/Unique_Life License'))

WebUI.setText(findTestObject('Admin/Create Agency/Field_Life License Number'), GlobalVariable.AgencyLifeLicenseNumber)

WebUI.setText(findTestObject('Admin/Create Agency/Field_Contact Name'), GlobalVariable.AgencyContactName3)

WebUI.setText(findTestObject('Admin/Create Agency/Field_Email Agency'), GlobalVariable.AgencyEmail6)

WebUI.setText(findTestObject('Admin/Create Agency/Field_Contact Number'), GlobalVariable.AgencyContactNumber3)
...
WebUI.verifyElementText(findTestObject('Admin/Create Agency/Unique_agency name'), 'reachwebtest3')
