...
WebUI.setText(findTestObject('Admin/Create Agency/Field_Email Agency'), GlobalVariable.AgencyEmail4)
...
WebUI.verifyElementText(findTestObject('Admin/Create Agency/Unique_agency name'), 'reachwebtest1')
