...
WebUI.click(findTestObject('Admin/Create Agent/Unique_Select Education2'))

WebUI.click(findTestObject('Admin/Create Agent/Field Of Study'))

WebUI.click(findTestObject('Admin/Create Agent/Unique_Select Field Of Study2'))
...
WebUI.setText(findTestObject('Admin/Create Agent/Field_Email_Agent'), GlobalVariable.AgentEmailAgent)
...
WebUI.click(findTestObject('Admin/Create Agent/Unique_Select Agency2'))

WebUI.click(findTestObject('Admin/Create Agent/button_Create'))

WebUI.verifyElementVisible(findTestObject('Admin/Create Agent/Unique_Error Mandatory Field3'))

WebUI.getText(findTestObject('Admin/Create Agent/Unique_Error Mandatory Field3'))

WebUI.verifyElementText(findTestObject('Admin/Create Agent/Unique_Error Mandatory Field3'), 'Mandatory field is required to be filled before creating agent.')
