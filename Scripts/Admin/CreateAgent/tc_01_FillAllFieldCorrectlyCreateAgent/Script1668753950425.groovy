...
WebUI.setText(findTestObject('Admin/Create Agent/Field_Email_Agent'), RandomStringUtils.randomNumeric(2) + '.com')
...
WebUI.verifyElementText(findTestObject('Admin/Create Agent/Unique_New agent'), 'richyagent5 Ben', FailureHandling.STOP_ON_FAILURE)
