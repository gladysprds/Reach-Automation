...
WebUI.setText(findTestObject('Admin/Update Policy/search_button'), 'AXA')

WebUI.verifyElementText(findTestObject('Admin/Update Policy/insurer'), 'AXA')

WebUI.setText(findTestObject('Admin/Update Policy/search_button'), 'AXAXA')

WebUI.verifyElementText(findTestObject('Admin/Update Policy/Error No Data'), 'No Data')
