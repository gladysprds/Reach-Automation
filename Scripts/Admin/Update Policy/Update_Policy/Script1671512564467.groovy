...
WebUI.setText(findTestObject('Admin/Update Policy/Field_Policy Name'), ' 1')

WebUI.setText(findTestObject('Admin/Update Policy/Field_Policy Description'), ' test')

WebUI.click(findTestObject('Admin/Update Policy/dropdown_Insurance Type'))

WebUI.click(findTestObject('Admin/Update Policy/Insurance Type'))

WebUI.click(findTestObject('Admin/Update Policy/insurer_checkbox'))
