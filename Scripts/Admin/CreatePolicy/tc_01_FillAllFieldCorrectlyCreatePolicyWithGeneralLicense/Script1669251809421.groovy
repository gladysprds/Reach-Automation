...
WebUI.setText(findTestObject('Admin/Create Policy/Field_Policy Description'), GlobalVariable.PolicyDescription)

WebUI.click(findTestObject('Admin/Create Policy/Unique_Dropdown Select License'))

WebUI.click(findTestObject('Admin/Create Policy/Unique_Choosing_General License'))
...
WebUI.verifyElementText(findTestObject('Admin/Create Policy/Unique_new_policy'), 'Term Life Insurance')
