...
WebUI.click(findTestObject('Admin/Updating Plan On Admin/Radio Button_Choose Your Method(Age Band)'))

WebUI.setText(findTestObject('Admin/Updating Plan On Admin/Field_Start Age'), '30')

WebUI.setText(findTestObject('Admin/Updating Plan On Admin/Field_Limit Age'), '10')

WebUI.setText(findTestObject('Admin/Updating Plan On Admin/Field_Plan 1 Premium Calculation'), '$ 12,444')

WebUI.click(findTestObject('Admin/Updating Plan On Admin/button_Add Age Band'))

WebUI.verifyElementText(findTestObject('Admin/Updating Plan On Admin/Unique_Error Age Limit'), 'Start age must be less than limit age')
