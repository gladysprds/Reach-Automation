...
WebUI.setText(findTestObject('Admin/Create Benefit/Field_Activation Criteria'), GlobalVariable.BenefitActivationCriteria)

WebUI.click(findTestObject('Admin/Create Benefit/Unique_Checkbox Insurer'))

WebUI.click(findTestObject('Admin/Create Benefit/Unique_Checkbox Reach Wording'))

WebUI.click(findTestObject('Admin/Create Benefit/Unique_Checkbox Reach Wording2'))

WebUI.click(findTestObject('Admin/Create Benefit/button_Create'))

WebUI.verifyElementText(findTestObject('Admin/Create Benefit/Unique_New benefit'), 'Death Accelerated')
