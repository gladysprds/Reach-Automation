...
WebUI.setText(findTestObject('Admin/Create Benefit/Field_Reach Wording Name'), GlobalVariable.BenefitName2)
...
WebUI.click(findTestObject('Admin/Create Benefit/Unique_Checkbox Policy Affected2'))

WebUI.click(findTestObject('Admin/Create Benefit/Unique_Reach Wording Insurer'))

WebUI.click(findTestObject('Admin/Create Benefit/Unique_Reach Wording Insurer2'))

WebUI.click(findTestObject('Admin/Create Benefit/button_Create'))

WebUI.verifyElementText(findTestObject('Admin/Create Benefit/Unique_New Reach Wording'), 'Critical Illness')
