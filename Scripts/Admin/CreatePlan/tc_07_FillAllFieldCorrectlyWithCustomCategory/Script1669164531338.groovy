...
WebUI.setText(findTestObject('Admin/Create Plan/Field_Package Name'), GlobalVariable.packagename2)
...
WebUI.click(findTestObject('Admin/Create Plan/button_CustomCategory'))

WebUI.setText(findTestObject('Admin/Create Plan/Field_table_name'), GlobalVariable.tableNameCustomCategory)

WebUI.setText(findTestObject('Admin/Create Plan/Field_Category_Class'), GlobalVariable.categoryClass)

WebUI.setText(findTestObject('Admin/Create Plan/Field_Plan1'), GlobalVariable.planCalculationPremium)

WebUI.click(findTestObject('Admin/Create Plan/button_AddCategory'))

WebUI.click(findTestObject('Admin/Create Plan/button_Create'))

WebUI.delay(5)

WebUI.verifyElementText(findTestObject('Admin/Create Plan/Unique_New_Plan'), 'myPackageName2', FailureHandling.STOP_ON_FAILURE)
