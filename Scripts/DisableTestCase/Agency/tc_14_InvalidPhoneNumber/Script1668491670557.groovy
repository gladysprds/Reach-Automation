...
WebUI.setText(findTestObject('Agency/SignUpPage_Reach_Agency/input_Email_email'), 'reachagency05@example.com')
...
WebUI.setText(findTestObject('Agency/SignUpPage_Reach_Agency/input_Phone Number_contactNumber'), '12345678910')
...
WebUI.verifyElementVisible(findTestObject('Agency/SignUpPage_Reach_Agency/div_Agency_Register'))
