...
WebUI.setText(findTestObject('Customer/SignUpPage_Reach_Customer/input_Email_email'), 'customerrich06@example.com')
...
WebUI.setText(findTestObject('Customer/SignUpPage_Reach_Customer/input_Phone Number_phone'), '+65 124 5')
