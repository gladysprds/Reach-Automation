...
WebUI.setText(findTestObject('Customer/SignUpPage_Reach_Customer/input_Email_email'), 'customerrich05@example.com')
...
WebUI.setText(findTestObject('Customer/SignUpPage_Reach_Customer/input_Phone Number_phone'), '+65 124 56789')
...
WebUI.verifyElementVisible(findTestObject('Customer/SignUpPage_Reach_Customer/div_signUpCustomer'))
