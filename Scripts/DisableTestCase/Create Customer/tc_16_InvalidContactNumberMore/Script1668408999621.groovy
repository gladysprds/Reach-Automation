...
WebUI.setText(findTestObject('Admin/Create Customer/Field_Phone_Number'), GlobalVariable.MoreContactNumber)
...
WebUI.waitForElementPresent(findTestObject('Admin/Create Customer/Unique_newcustomer'), 2000)

WebUI.verifyElementText(findTestObject('Admin/Create Customer/Unique_newcustomer'), 'Julio Han')
