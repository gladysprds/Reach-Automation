...
WebUI.click(findTestObject('Agent/Create Remarketing Exercise/Page_Reach/Unique_choosing package plan2'))
...
WebUI.verifyTextPresent('Aido', true)

WebUI.click(findTestObject('Agent/Create Remarketing Exercise/Page_Reach/button_Next2'))

WebUI.click(findTestObject('Agent/Create Remarketing Exercise/Page_Reach/button_Save as Draft'))

WebUI.click(findTestObject('Agent/Create Remarketing Exercise/Page_Reach/button_Yes_Save Draft'))

WebUI.scrollToElement(findTestObject('Agent/Create Remarketing Exercise/Page_Reach/Unique_remarketing exercise table'), 
    2)
