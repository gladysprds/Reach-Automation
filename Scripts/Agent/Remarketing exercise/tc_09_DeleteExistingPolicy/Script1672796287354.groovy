...
WebUI.click(findTestObject('Agent/Create Remarketing Exercise/Page_Reach/button_Delete Policy'))

WebUI.click(findTestObject('Agent/Create Remarketing Exercise/Page_Reach/button_Yes_option'))

WebUI.click(findTestObject('Agent/Create Remarketing Exercise/Page_Reach/button_Update Customer data'))

WebUI.verifyTextNotPresent('policy for delete', true)
