...
WebUI.verifyElementText(findTestObject('Agent/Create Remarketing Exercise/Page_Reach/Unique_pop up generate quotation slip successfully'), 
    'Generate application form Successfully')
