...
WebUI.click(findTestObject('Agent/Create Remarketing Exercise/Page_Reach/Unique_choosing start date'))

WebUI.click(findTestObject('Agent/Create Remarketing Exercise/Page_Reach/Field_End Date'))

WebUI.click(findTestObject('Agent/Create Remarketing Exercise/Page_Reach/button_change year'))

WebUI.click(findTestObject('Agent/Create Remarketing Exercise/Page_Reach/button_change date'))
...
WebUI.verifyTextPresent('Invalid date inputted', false)
