...
WebUI.click(findTestObject('Agent/Create Remarketing Exercise/Page_Reach/button_Back Page 2'))

WebUI.verifyElementPresent(findTestObject('Agent/Create Remarketing Exercise/Page_Reach/Field_Exercise Name'), 2)

WebUI.click(findTestObject('Agent/Create Remarketing Exercise/Page_Reach/Unique_choosing existing policy'))

WebUI.click(findTestObject('Agent/Create Remarketing Exercise/Page_Reach/button_Next'))

WebUI.click(findTestObject('Agent/Create Remarketing Exercise/Page_Reach/Unique_checkbox for select package plan - Copy'))

WebUI.click(findTestObject('Agent/Create Remarketing Exercise/Page_Reach/button_Next2'))

WebUI.click(findTestObject('Agent/Create Remarketing Exercise/Page_Reach/button_Back Page 3'))

WebUI.verifyElementPresent(findTestObject('Agent/Create Remarketing Exercise/Page_Reach/Unique_checkbox for select package plan - Copy'), 
    2)
...
WebUI.click(findTestObject('Agent/Create Remarketing Exercise/Page_Reach/button_Back Page 4'))

WebUI.verifyElementPresent(findTestObject('Agent/Create Remarketing Exercise/Page_Reach/Unique_employee_list table'), 2)
