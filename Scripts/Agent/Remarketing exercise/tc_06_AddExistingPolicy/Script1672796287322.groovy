...
WebUI.click(findTestObject('Agent/Create Remarketing Exercise/Page_Reach/Unique_Choosing customer3'))

WebUI.click(findTestObject('Agent/Create Remarketing Exercise/Page_Reach/button_Create'))

WebUI.setText(findTestObject('Agent/Create Remarketing Exercise/Page_Reach/Field_Exercise Name'), GlobalVariable.RemarketingExerciseName3)
...
WebUI.click(findTestObject('Agent/Create Remarketing Exercise/Page_Reach/button_Edit_ExistingPolicy'))

WebUI.click(findTestObject('Agent/Create Remarketing Exercise/Page_Reach/button_Add More Existing Policy'))

WebUI.click(findTestObject('Agent/Create Remarketing Exercise/Page_Reach/Field_Add More Existing Policy'))

WebUI.click(findTestObject('Agent/Create Remarketing Exercise/Page_Reach/Add Existing Policy'))

WebUI.click(findTestObject('Agent/Create Remarketing Exercise/Page_Reach/button_Update Customer data'))

WebUI.verifyElementText(findTestObject('Agent/Create Remarketing Exercise/Page_Reach/Unique_Verify existing policy just added'), 
...
WebUI.click(findTestObject('Agent/Create Remarketing Exercise/Page_Reach/Unique_choosing package plan'))

WebUI.click(findTestObject('Agent/Create Remarketing Exercise/Page_Reach/button_Next2'))

WebUI.click(findTestObject('Agent/Create Remarketing Exercise/Page_Reach/button_Finalize'))

WebUI.click(findTestObject('Agent/Create Remarketing Exercise/Page_Reach/button_Save as Draft'))
...
WebUI.verifyMatch(exercise, GlobalVariable.RemarketingExerciseName3, true)
