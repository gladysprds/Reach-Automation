...
WebUI.click(findTestObject('Agent/Create Remarketing Exercise/Page_Reach/button_Send Application Form'))

WebUI.setText(findTestObject('Agent/Create Remarketing Exercise/Page_Reach/Field_Email CC'), 'gladys@cmail.com')

WebUI.setText(findTestObject('Agent/Create Remarketing Exercise/Page_Reach/Field_Email BCC'), 'gladys@cmail.com')

WebUI.setText(findTestObject('Agent/Create Remarketing Exercise/Page_Reach/Field_Email Description'), 'gladys@cmail.com')

WebUI.click(findTestObject('Agent/Create Remarketing Exercise/Page_Reach/button_Cancel Send Email'))

WebUI.click(findTestObject('Agent/Create Remarketing Exercise/Page_Reach/button_Send Application Form'))

WebUI.click(findTestObject('Agent/Create Remarketing Exercise/Page_Reach/button_Send Email'))

WebUI.delay(2)

WebUI.verifyElementText(findTestObject('Agent/Create Remarketing Exercise/Page_Reach/Unique_pop up send quotation slip successfully'), 
    'Generate application form Successfully and already send to insurer')
