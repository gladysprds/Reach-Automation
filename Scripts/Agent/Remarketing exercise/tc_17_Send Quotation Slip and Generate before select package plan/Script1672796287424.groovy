...
WebUI.verifyElementText(findTestObject('Agent/Create Remarketing Exercise/Page_Reach/Unique_error send quotation before select package plan'), 
    'Please select package plan before send application form')

WebUI.click(findTestObject('Agent/Create Remarketing Exercise/Page_Reach/button_Ok'))

WebUI.click(findTestObject('Agent/Create Remarketing Exercise/Page_Reach/button_Generate Application Form'))

WebUI.verifyElementText(findTestObject('Agent/Create Remarketing Exercise/Page_Reach/Unique_error send quotation before select package plan'), 
    'Please select package plan before generate application form')
