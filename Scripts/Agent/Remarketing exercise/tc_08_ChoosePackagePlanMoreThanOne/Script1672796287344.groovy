...
WebUI.click(findTestObject('Agent/Create Remarketing Exercise/Page_Reach/Unique_Choosing customer4'))
...
WebUI.click(findTestObject('Agent/Create Remarketing Exercise/Page_Reach/Unique_choosing another package plan'))

WebUI.click(findTestObject('Agent/Create Remarketing Exercise/Page_Reach/button_Save as Draft'))

WebUI.click(findTestObject('Agent/Create Remarketing Exercise/Page_Reach/button_Yes'))
...
WebUI.verifyMatch(exercise, GlobalVariable.RemarketingExerciseName, true)
