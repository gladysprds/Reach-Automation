...
WebUI.setText(findTestObject('Agent/Sign In Agent/input_Email_email'), GlobalVariable.validemailagent)

WebUI.setText(findTestObject('Agent/Sign In Agent/input_Password_password'), GlobalVariable.validpassword)
