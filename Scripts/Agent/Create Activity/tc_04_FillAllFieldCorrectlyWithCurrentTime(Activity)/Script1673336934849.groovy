...
WebUI.click(findTestObject('Agent/Create Activity/choose_start_date(current)'))

WebUI.click(findTestObject('Agent/Create Activity/dropdown_start_time'))

WebUI.click(findTestObject('Agent/Create Activity/choose_start_time(current)'))

WebUI.click(findTestObject('Agent/Create Activity/Field_end_date'))

WebUI.click(findTestObject('Agent/Create Activity/choose_end_date(current)'))

WebUI.click(findTestObject('Agent/Create Activity/dropdown_end_time'))

WebUI.click(findTestObject('Agent/Create Activity/choose_end_time(current)'))
...
WebUI.verifyElementText(findTestObject('Agent/Create Activity/Unique_Verify_Activity Name'), 'repeat Activity')
