...
WebUI.click(findTestObject('Agent/Create Activity/Field_Start Time'))
...
WebUI.click(findTestObject('Agent/Create Activity/choose_Invalid_end_time'))

WebUI.click(findTestObject('Agent/Create Activity/button_OK2'))

WebUI.click(findTestObject('Agent/Create Activity/button_Create Activity'))

WebUI.verifyElementText(findTestObject('Agent/Create Activity/Unique_Verify_Invalid Date Information'), 'Invalid Date & Information')
