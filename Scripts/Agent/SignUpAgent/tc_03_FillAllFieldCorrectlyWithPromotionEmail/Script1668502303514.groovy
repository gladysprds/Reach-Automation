...
WebUI.setText(findTestObject('Agent/Sign Up Page Reach Agent/input_Email_email'), GlobalVariable.username13)
...
WebUI.click(findTestObject('Agent/Sign Up Page Reach Agent/input_Kiara Ardina_05385688-ba91-424e-92cf-_9373e1'))

WebUI.click(findTestObject('Agent/Sign Up Page Reach Agent/span_Select Agency'))
