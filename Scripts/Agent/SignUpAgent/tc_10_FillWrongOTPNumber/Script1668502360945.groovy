...
WebUI.setText(findTestObject('Agent/Sign Up Page Reach Agent/input_Email_email'), GlobalVariable.username16)
...
WebUI.setText(findTestObject('Agent/Sign Up Page Reach Agent/input2'), '8')

WebUI.click(findTestObject('Agent/Sign Up Page Reach Agent/input3'))

WebUI.setText(findTestObject('Agent/Sign Up Page Reach Agent/input3'), '9')
