...
WebUI.setText(findTestObject('Agent/Sign Up Page Reach Agent/input_Mas Representative Number_masNumber'), '123456789')

WebUI.verifyElementNotClickable(findTestObject('Agent/Sign Up Page Reach Agent/Button_Create Account'))
