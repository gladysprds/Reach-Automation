...
WebUI.setText(findTestObject('Agent/Sign Up Page Reach Agent/input_Create New Password_password'), 'Brief123*')

WebUI.setText(findTestObject('Agent/Sign Up Page Reach Agent/input_Last Name_lastName'), 'Adiboy')

WebUI.click(findTestObject('Agent/Sign Up Page Reach Agent/input_I am licensed to sell_ant-checkbox-input'))

WebUI.setText(findTestObject('Agent/Sign Up Page Reach Agent/input_Mas Representative Number_masNumber'), '12345678910')
...
WebUI.verifyElementVisible(findTestObject('Agent/Sign Up Page Reach Agent/div_Please input MAS valid number'))
