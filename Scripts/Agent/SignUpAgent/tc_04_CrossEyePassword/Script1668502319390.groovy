...
WebUI.click(findTestObject('Agent/Sign Up Page Reach Agent/CrossEye'))
...
WebUI.verifyElementVisible(findTestObject('Agent/Sign Up Page Reach Agent/div_Please input your Password'))
